...
val dummyPrograms = listOf(
    ...
    Program(id = 2, image = R.drawable.pijarity_beast2, title = "Open Donation For Rohingya", date = "12 January 2024", location = "Jl. Burung Puyuh, Kabupaten Mergoasin, Jakarta", availability = "Sold Out", description = "Pijarity x Prime Community is an event held to provide charity to communities affected by natural disasters. With you buying this ticket, you will help the affected communities."),
    Program(id = 3, image = R.drawable.charity_for_humanity, title = "Anasthesia Concert For Charity", date = "12 January 2024", location = "Jl. Burung Puyuh, Kabupaten Mergoasin, Jakarta", availability = "Available", description = "Pijarity x Prime Community is an event held to provide charity to communities affected by natural disasters. With you buying this ticket, you will help the affected communities."),
